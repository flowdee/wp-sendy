...
if ( ! class_exists( 'SFWP_Courses_Widget' ) ) {

    /**
     * Adds SFWP_Courses widget.
     */
    class SFWP_Courses_Widget extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                'sfwp_single_widget', // Base ID
                __( 'SFWP - Courses', 'wp-sendy' ), // Name
                array( 'description' => __( 'Displaying courses by their ids.', 'wp-sendy' ), ) // Args
            );
        ...
        public function widget( $args, $instance ) {
            ...
            if ( ! empty ( $instance['ids'] ) ) {
                ...
                _e( 'Please enter a course ID.', 'wp-sendy' );
            }
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'ids' ) ); ?>"><?php _e( 'Course IDs:', 'wp-sendy' ); ?></label>
                ...
                <br />
                <small>
                    <?php _e( 'You can enter multiple course IDs and separate them by comma.', 'wp-sendy' ); ?>
                </small>
            </p>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'url' ) ); ?>"><?php _e( 'Custom URL:', 'wp-sendy' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'url' ) ); ?>" type="text" value="<?php echo esc_attr( $url ); ?>">
                <br />
                <small>
                    <?php _e( 'Only working when entering one course id.', 'wp-sendy' ); ?>
                </small>
            </p>
