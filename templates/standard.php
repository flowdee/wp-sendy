                ...
                <a class="ufwp-course__link" href="<?php echo $course->get_url(); ?>" target="_blank" rel="nofollow" title="<?php echo $course->get_title(); ?>">
                    ...
                    <span class="ufwp-course__content">
                        ...
                        <span class="ufwp-course__footer">
                            ...
                            <span class="ufwp-course__rating"><?php $course->the_star_rating(); ?> <?php echo $course->get_rating(); ?> (<?php printf( esc_html__( '%1$s ratings', 'wp-sendy' ), $course->get_reviews() ); ?>)</span>
                            <?php if ( $course->show_meta() ) { ?>
                                <span class="ufwp-course__meta"><?php printf( esc_html__( '%1$s lectures', 'wp-sendy' ), $course->get_lectures() ); ?>, <?php printf( esc_html__( '%1$s hours', 'wp-sendy' ), $course->get_playing_time() ); ?></span>
                            <?php } ?>
                        </span>
                    </span>
                </a>
